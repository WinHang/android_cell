...
//                mMediaStream = EasyApplication.sMS;
    ...
    public void onBackPressed() {
        ...
        if (isStreaming && PreferenceManager.getDefaultSharedPreferences(this)
            ...
            new AlertDialog.Builder(this).setTitle("是否允许后台上传？")
                    ...
                    .setNeutralButton("后台采集", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            PreferenceManager.getDefaultSharedPreferences(StreamActivity.this)
                                    .edit().putBoolean("background_camera_alert", true).apply();
