...
import com.zkzj.rtmp_terminal.listeners.DialogAssigner;
import com.zkzj.rtmp_terminal.listeners.DialogUIDateTimeSaveListener;
import com.zkzj.rtmp_terminal.listeners.DialogUIItemListener;
import com.zkzj.rtmp_terminal.listeners.DialogUIListener;
import com.zkzj.rtmp_terminal.listeners.TdataListener;
import com.zkzj.rtmp_terminal.widget.PopuWindowView;
...
public class DialogUIUtils {
     ...
     * @return
     */
    public static BuildBean showDatePick(Context context, int gravity, String dateTitle,
                                         long date, int dateType, int tag, DialogUIDateTimeSaveListener listener) {
        return DialogAssigner.getInstance().assignDatePick(context, gravity, dateTitle,
                date, dateType, tag, listener);
    }
     ...
     * @return
     */
    public static BuildBean showMdAlert(Activity activity, CharSequence title,
                                        CharSequence msg, boolean cancleable,
                                        boolean outsideTouchable, DialogUIListener listener) {
        return DialogAssigner.getInstance().assignMdAlert(activity, title, msg,
                cancleable, outsideTouchable, listener);
    }
     ...
     * @return
     */
    public static BuildBean showMdMultiChoose(Activity activity, CharSequence title,
                                              CharSequence[] words, boolean[] checkedItems,
                                              boolean cancleable, boolean outsideTouchable,
                                              DialogUIListener listener) {
        return DialogAssigner.getInstance().assignMdMultiChoose(activity, title, words,
                checkedItems, cancleable, outsideTouchable, listener);
    }
     ...
     * @param listener      事件监听
     */
    public static BuildBean showSingleChoose(Activity activity, CharSequence title,
                                             int defaultChosen, CharSequence[] words,
                                             DialogUIItemListener listener) {
        return showSingleChoose(activity, title, defaultChosen, words, true,
                true, listener);
    }
    ...
    public static BuildBean showSingleChoose(Activity activity, CharSequence title,
                                             ...
                                             boolean cancleable, boolean outsideTouchable,
                                             DialogUIItemListener listener) {
        return DialogAssigner.getInstance().assignSingleChoose(activity, title, defaultChosen,
                words, cancleable, outsideTouchable, listener);
    }
    ...
    public static BuildBean showAlert(Activity activity, CharSequence title, CharSequence msg,
                                      ...
                                      boolean isVertical, boolean cancleable,
                                      boolean outsideTouchable, DialogUIListener listener) {
        return DialogAssigner.getInstance().assignAlert(activity, title, msg, hint1, hint2,
                firstTxt, secondTxt, isVertical, cancleable, outsideTouchable, listener);
    }
     ...
     * @param listener         事件监听
     */
    public static BuildBean showAlertResetPwd(Activity activity, CharSequence title,
                                              CharSequence oldPwd, CharSequence newPwd1, CharSequence newPwd2,
                                              CharSequence firstTxt, CharSequence secondTxt,
                                              boolean cancleable,
                                              boolean outsideTouchable,
                                              DialogUIListener listener) {
        return DialogAssigner.getInstance().assignResetPwdAlert(activity, title, oldPwd, newPwd1, newPwd2,
                firstTxt, secondTxt, cancleable, outsideTouchable, listener);
    }
     ...
     * @return
     */
    public static BuildBean showSheet(Context context, List<TieBean> datas, CharSequence bottomTxt,
                                      int gravity, boolean cancleable, boolean outsideTouchable,
                                      DialogUIItemListener listener) {
        return DialogAssigner.getInstance().assignSheet(context, datas, bottomTxt, gravity,
                cancleable, outsideTouchable, listener);
    }
     ...
     * @return
     */
    public static BuildBean showMdBottomSheet(Context context, boolean isVertical,
                                              CharSequence title, List<TieBean> datas,
                                              int columnsNum, DialogUIItemListener listener) {
        return showMdBottomSheet(context, isVertical, title, datas, columnsNum, true,
                true, listener);
    }
    ...
    public static BuildBean showMdBottomSheet(Context context, boolean isVertical,
                                              CharSequence title, List<TieBean> datas,
                                              int columnsNum, boolean cancleable,
                                              boolean outsideTouchable, DialogUIItemListener listener) {
        return DialogAssigner.getInstance().assignMdBottomSheet(context, isVertical,
                title, datas, columnsNum, cancleable, outsideTouchable, listener);
    }
     ...
     * @return
     */
    public static BuildBean showCustomBottomAlert(Context context, View contentView, boolean cancleable,
                                                  boolean outsideTouchable) {
        return DialogAssigner.getInstance().assignCustomBottomAlert(context, contentView,
                cancleable, outsideTouchable);
    }
    ...
    public static void showTie(Context context, String str) {
        ...
        mBuildBean = showLoading(context, str, false, true, false,
                true);
        mBuildBean.show();
    }
    ...
    public static void showPopuWindow(Context context, int widthGravity, int maxLine, View view,
                                      TdataListener tdataListener) {
