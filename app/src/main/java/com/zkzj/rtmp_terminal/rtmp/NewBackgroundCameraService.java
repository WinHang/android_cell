...
public class NewBackgroundCameraService extends Service implements TextureView.SurfaceTextureListener,
        AudioObserver {
    ...
    private void backGroundNotificate() {
        ...
        Notification notification =
                new NotificationCompat.Builder(this, EasyApplication.CHANNEL_CAMERA)
                        .setContentTitle(getString(org.easydarwin.easypusher.R.string.app_name))
                        .setContentText(getString(org.easydarwin.easypusher.R.string.video_uploading_in_background))
                        .setSmallIcon(org.easydarwin.easypusher.R.drawable.ic_stat_camera)
    ...
    public class LocalBinder extends Binder {
        public NewBackgroundCameraService getService() {
            return NewBackgroundCameraService.this;
        }
    }
