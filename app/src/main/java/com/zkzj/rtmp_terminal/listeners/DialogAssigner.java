...
public class DialogAssigner implements Assignable {
    ...
    @Override
    public BuildBean assignResetPwdAlert(Activity activity, CharSequence title,
        ...
        bean.title = title;
        bean.oldPwd = oldPwd;
        bean.newPwd1 = newPwd1;
        bean.newPwd2 = newPwd2;
        bean.text1 = firstTxt;
        bean.text2 = secondTxt;
        bean.gravity = Gravity.CENTER;
        bean.cancelable = cancleable;
        bean.outsideTouchable = outsideTouchable;
        bean.listener = listener;
        bean.type = DialogConfig.TYPE_RESET_PWD_ALERT;
        return bean;
    }
}