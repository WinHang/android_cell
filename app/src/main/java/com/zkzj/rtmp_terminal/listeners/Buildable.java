...
import com.zkzj.rtmp_terminal.config.DialogConfig;
import com.zkzj.rtmp_terminal.holder.AlertDialogHolder;
import com.zkzj.rtmp_terminal.holder.AlertSetPwdDialogHolder;
import com.zkzj.rtmp_terminal.holder.SheetHolder;
import com.zkzj.rtmp_terminal.utils.DialogUIUtils;
import com.zkzj.rtmp_terminal.utils.ToolUtils;
import com.zkzj.rtmp_terminal.widget.DateSelectorWheelView;
...
public class Buildable {
    ...
    protected BuildBean buildByType(BuildBean bean) {
        ...
        switch (bean.type) {
            ...
            case DialogConfig.TYPE_BOTTOM_SHEET:
                ...
                break;
            case DialogConfig.TYPE_RESET_PWD_ALERT:
                buildResetPwdAlert(bean);
                break;
            default:
                break;
    ...
    protected BuildBean buildResetPwdAlert(BuildBean bean) {
        AlertDialog.Builder builder = new AlertDialog.Builder(bean.mContext);
        AlertSetPwdDialogHolder holder = new AlertSetPwdDialogHolder(bean.mContext);
        builder.setView(holder.rootView);
        AlertDialog dialog = builder.create();
        bean.alertDialog = dialog;
        holder.assingDatasAndEvents(bean.mContext, bean);
